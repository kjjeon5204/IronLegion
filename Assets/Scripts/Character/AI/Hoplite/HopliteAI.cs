...
public class HopliteAI : Character {
	...
	public GameObject leftLegExhaust;
	public GameObject rightLegExhaust;
	...
	public override void manual_start () {
		...
		leftLegExhaust.SetActive(false);
		rightLegExhaust.SetActive (false);
	...
	void exhaust_check() {
		if (currentStates == CurrentStates.SLASH || currentStates == CurrentStates.SONICCHARGE) {
			leftBackExhaust.SetActive (true);
			rightBackExhaust.SetActive (true);
			leftLegExhaust.SetActive (true);
			rightLegExhaust.SetActive (true);
		} 
		else {
			leftBackExhaust.SetActive  (false);
			rightBackExhaust.SetActive (false);

...
public class MapZoomSliderControls : BaseUIButton {
    public OverworldSceneControls ovSceneControl;
    GameObject mLeftLimit;
    GameObject mRightLimit;
    GameObject mTopLimit;
    GameObject mBottomLimit;
    ...
    public GameObject curChapterIndicator;

    

    /*This function is used to set certain chapter. Simply call this function with an int value 
     representing the chapter access number*/
    public void set_current_chapter(MapChapterControl curChapter)
    {
        MapChapterControl mapControl = curChapter;
        mLeftLimit = mapControl.mLeftLimit;
        mRightLimit = mapControl.mRightLimit;
        mTopLimit = mapControl.mTopLimit;
        mBottomLimit = mapControl.mBottomLimit;
